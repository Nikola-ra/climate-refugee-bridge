      ...
      <div className="container px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            SDG 13 aims to take urgent action to combat climate change and its
            impacts, especially for vulnerable communities.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <ul className="space-y-4">
            <li className="flex items-start">
              <span className="inline-flex items-center justify-center h-6 w-6 rounded-full bg-ocean-light mr-3 mt-1 flex-shrink-0">
                1
              </span>
              <p>
                <strong>Increasing disasters:</strong> Climate change is
                intensifying hurricanes, floods, and wildfires, forcing
                communities to abandon their homes and livelihoods.
              </p>
            </li>
            <li className="flex items-start">
              <span className="inline-flex items-center justify-center h-6 w-6 rounded-full bg-ocean-light mr-3 mt-1 flex-shrink-0">
              ...
              <p>
                <strong>Rising sea levels:</strong> Coastal communities and
                small island nations face existential threats as oceans rise,
                with some projections showing complete submersion of inhabited
                areas.
              </p>
            </li>
            <li className="flex items-start">
              ...
              <p>
                <strong>Resource scarcity:</strong> Changing precipitation
                patterns and extreme weather lead to crop failures and water
                shortages, triggering mass migration.
              </p>
            </li>
          </ul>
        </div>
